...
public class Po_TVS_Admin_Add_Procument_Member 
{
	WebDriver driver;
	public Po_TVS_Admin_Add_Procument_Member(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	@FindBy(how=How.XPATH,using ="//a [@href='http://192.168.1.10/showroom/admin/Procurementmember']")
	WebElement Click_Procurement_Member;
	
	@FindBy(how=How.XPATH,using ="//a [@id='addModalprocurement']")
	WebElement Click_Procurement_Member_Button;
	...
	@FindBy(how=How.XPATH,using ="(//i[@class='fa fa-pen'])[1]")
	...
	public void Btn_Procurement_Member()
	{
		Click_Procurement_Member.click();
	}
	public void Btn_Add_Procurement_Button()
	{
		Click_Procurement_Member_Button.click();
